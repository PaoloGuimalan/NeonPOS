...
import { AuthenticationInterface, ProductDataInterface } from '../../../../helpers/typings/interfaces';
                    ...
                    return(
                      <div key={i} className='bg-white flex flex-col shadow-md flex flex-col p-[20px] h-fit w-full max-w-[350px] gap-[10px] select-none'>
                        <div className='w-full'>
                          <img src={mp.previews[0]} className='w-full max-w-[100%] select-none' />
                        </div>
                        ...
                        <div className='w-full flex flex-row gap-[4px] pt-[10px]'>
                          <button className='bg-green-500 cursor-pointer flex flex-1 justify-center items-center h-[35px] shadow-sm text-white font-semibold rounded-[4px]'>
        ...
        {togglewidget === "cart" && (
          <div className='w-full max-w-[450px] bg-shade p-[0px] flex flex-col pt-[20px] pb-[20px] pr-[10px] gap-[10px]'>
            ...
            <div className='w-full flex flex-col gap-[10px] bg-white p-[15px] pt-[20px] h-fit'>
                <div className='bg-shade p-[20px] flex flex-col gap-[5px] h-[400px] overflow-y-scroll'>
                  <span>--</span>
                </div>
